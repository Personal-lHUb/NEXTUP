# Dates, Names, and the Records That Are Supposed to Settle Them
...
## What an absence does not settle

This is the half that sceptical readers get wrong, and I include it first because this book is not a debunking.

If a client describes an ordinary woman in an ordinary place in a period with poor record survival, and a search finds nothing, that result was essentially guaranteed in advance. The search had no power to detect anything. A test that would return the same answer whether or not the claim were true is not a test.

So "no trace could be found" is a statement about the archive, not about the session. It would be the expected outcome for a perfectly accurate account, and it is also the expected outcome for pure invention, and it therefore distinguishes between them not at all.

I have read accounts in which an empty search is reported as though it settled the matter. It does not. What it settles is that the question was not askable in that form.

## What a match does not settle either

And this is the half that believing readers get wrong.

A match means something only in proportion to how unlikely it was. That is the whole of it, and everything else in this chapter is detail.

Consider a client who gives a common first name and says the person lived near a river in a particular region. A search finds such a person. What has been established? Almost nothing: the name was common, the region is large, rivers are numerous, and the period is long. You would expect to find a match. Finding one is not informative.

Now consider a client who gives an unusual name, a specific small settlement, a year, and an occupation — and all four line up in a single record. That would be worth something, and the reason is that the space of possible wrong answers was enormous and the account landed in it.
...
These are the mechanisms, and once you can name them you will see them constantly.
...
Since this book asks you to trust its checks, here is the procedure, so you can judge it.

First, I write out the checkable claim exactly as the client said it, from the recording, with my questions included. If the claim as stated is vague, that is the claim; I do not sharpen it.

Second, I write down, before searching, what a meaningful match would look like and roughly how many candidates I would expect to exist. If the answer is "lots," I note that the search is not going to be informative and I usually still do it, because the client has asked.
...
Abstract rules are easy to agree with, so here is the procedure run on an invented but entirely typical case, with the numbers made explicit.

A client says: *my name is Anne. I'm near the water. There's a mill.*
...
Then I search anyway, because she asked, and I find — inevitably — several. Let us say eleven plausible candidates in the first hour.

Here is where accounts go wrong. The temptation at this point is enormous, and it is not a temptation to lie. It is a temptation to *choose*. One of those eleven will be more interesting than the others: she will have died young, or had a name that echoes something else in the session, or lived somewhere with a resonant name. The account then features that one, and the other ten quietly do not appear, and a reader is shown a match rather than a list.

The correct report is: *eleven candidates, which is fewer than I expected, and the exercise tells us nothing.* That sentence has never appeared in a book on this subject as far as I know.

Then the fourth step: I ask her where she might have encountered mills. She says her grandparents lived by one. That takes four minutes and it is the end of the matter.

## What this leaves us with

A hard conclusion, and I would rather state it than soften it.

For the overwhelming majority of sessions, the documentary record cannot help. The material is not the kind that leaves traces, about people who did not leave traces, in periods that did not keep them. The question "did this happen?" is not merely unanswered in this field. For most cases, it is not answerable by any means currently available, and it is not going to become answerable.
