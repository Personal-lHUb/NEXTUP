# The Session That Checked Out, and Why I Still Won't Call It Proof

This is the one.

Out of everything in this book, there is a single session in which a client produced a specific, unusual, checkable detail, and the detail turned out to correspond to something real and findable. I have put it in the middle of the book rather than at the end, where it would have more impact, because I do not want it doing the work of a climax.

It is also the chapter readers will argue with, and I would rather they argued with this version than with a better-written one.

## Ruth

Ruth was fifty-six, an accountant, and about as unlikely a candidate as I have had. She came because her sister had bought her a session as a birthday present, an arrangement I generally dislike and accepted because Ruth was plainly amused by it rather than resentful.

Her expectation, stated in the intake: "None. I think my sister has wasted her money and I shall tell her so."

She settled in fourteen minutes.

## What she described

Most of the session was unremarkable and I will not pretend otherwise. A road or a track, walked on repeatedly. Weather, in some detail — she was very concerned with weather. A sense of carrying something heavy on one side. A building she described only as "the long one."

Then, about an hour in, this:

> — What are you aware of?
>
> — There's the thing on the gate. *(pause)* The iron thing.
>
> — Tell me about the iron thing.
>
> — It's a — *(sixteen seconds)* — it's a hoop and it's got the twist in it. You put your hand through it and you twist it and it lets go.
>
...
I asked her, without telling her what I had found, whether she had ever had any interest in ironwork, blacksmithing, gates, or rural crafts of any kind. She said no, in the tone of someone confirming that they have never been interested in competitive fishing.

Then I described the latch.

There was a long pause, and then she said: "Oh, God. The forge."

When she was eight, her school took a trip to a working museum. She has almost no memory of it: a day out, a packed lunch, a bus. What she does remember, and remembered the moment I described the object, is a blacksmith's forge with a display of finished pieces, and being allowed to hold something, and her mother keeping a leaflet on the kitchen dresser for years afterwards because Ruth had been so taken with it.

She could not tell me which museum. She could not tell me what was on the leaflet. She is confident — not certain — that the bird was in it, because the phrase that came back to her was "the one with the bird on."

That is forty-eight years between the forge and the session, and a leaflet on a dresser for some unknown portion of it.

## What a hit is worth

Here is the arithmetic that took the vertigo away, and I recommend doing it every time.

A session of two hours produces, in my experience, somewhere between forty and a hundred discrete concrete details: objects, textures, actions, weather, complaints, scraps of speech. Call it sixty.
...
Because a forty-eight-year-old memory of a museum leaflet is not merely a possible explanation. It is the *likely* one, and we found it in a five-minute phone call, and we found it on the first try.

I did not have to hunt for a way to explain Ruth's latch away. I asked one question and she supplied a forge. If an ordinary explanation is that easy to find, the honest conclusion is not "we cannot rule it out" — it is "this is probably what happened."

There is a form of words that gets used at this point in other people's accounts: *of course, she may have encountered such an object as a child, though this seems unlikely given the specificity of her description.* I could write that sentence about Ruth. It would be false, and the falsehood is in "seems unlikely," which is doing all the work and resting on nothing.

## The three ways this chapter could have gone
...
**The third version** is this one: make the call, report what she said, and state that the ordinary explanation is the likely one. It is the least satisfying to read and the only one I can stand behind.

The reason I am spelling this out is that you will meet the first two versions constantly once you know what they look like, and you will meet them in books written by people who are not trying to deceive anyone. The structure does the deceiving. A writer can hold every individual sentence to a high standard and still assemble them into an argument the evidence does not support, and the only defence is to ask what the paragraph is *for* rather than whether it is accurate.
...
Ruth's own view, which she gave me unprompted and which I have not improved upon: "So my brain kept a leaflet for forty-eight years and wouldn't give it back until I lay down. That's worse, isn't it. That's much more frightening than the other thing."
