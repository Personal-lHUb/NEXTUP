...
> *(eleven seconds)*
>
> — There's a. It's wet. Not — the floor isn't wet, the wall's wet.
>
> — Tell me about the wall.
>
> — It's. Cold. *(seven seconds)* There's a mark on it where the — where something's been. Been rubbing.
>
> *(nineteen seconds)*
>
...
> — Tell me about that.
>
> — It's thick. It's a thick wall. You can't hear through it. *(pause)* You can't hear them through it.
>
> — Is there anything else there?
>
> *(twenty-six seconds)*
>
> — The window's too high. I don't like — it's too high up, you can't. There's light but you can't see out, it's up here. *(pause)* It's up here.
>
> — What are you aware of?
>
> — My back hurts. *(pause)* It's the standing.
>
> *(forty seconds)*
>
> — I'm doing the thing with the. There's a pan and I'm doing the. Scraping it. *(pause)* It's burnt on the bottom, I have to get it off before she. Before.
>
> — Tell me about that.
>
...
Look at what arrives and in what order.

The wall comes first, and the wall is wet and cold, which is a body sensation before it is a description. Then the mark from rubbing, which is a detail nobody invents because it is not interesting. Then, unprompted and slightly out of nowhere, a judgement: *it's a good wall though*. Then the reason for the judgement, which turns out to be about not hearing people.

Then the window, which is too high, and which she says twice with a different emphasis. Then her back. Then a pan.
...
If I clean that passage up, I get this:
...
I have added something, too, without meaning to: *with something like affection*. That is my inference about her tone, presented as part of the account. It may even be right. It is not something she said.

## How to read a rough transcript

If you are going to read several of these, it helps to know what to look at, because the untidied version does not guide you the way prose does.

Watch what arrives first. In almost every session the opening material is sensory and bodily — temperature, texture, weight, the state of the hands and feet — and the furniture of a scene assembles afterwards, if it assembles at all. Ellen gets to a wall before she gets to a room, and she never does get to a house. An account that opens with a village and a year and a profession has been through somebody's hands.

Watch for the unprompted judgement. *It's a good wall though.* Nobody asked her to evaluate the wall; it came out sideways, attached to nothing, and it turned out to be the entrance to the only emotionally loaded thing in the passage. Those sideways remarks are where the sessions go, consistently, and they are the first casualty of tidying because they look like noise.

Watch the repetitions. *It's up here. It's up here.* A repeated phrase in that chair is not emphasis and it is not a stutter. It usually means the client is still looking, and the second saying is a different event from the first — often slower, often with something added on the end a few seconds later.
